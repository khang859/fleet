...
describe('formatTimeContext', () => {
  ...
  it('includes a weekday, the IANA zone, and an offset-bearing local ISO', () => {
    ...
    // IANA zone in parentheses on line 1: "UTC", "America/Los_Angeles", a
    // three-part zone like "America/Argentina/Buenos_Aires", or a hyphenated
    // one like "America/Port-au-Prince".
