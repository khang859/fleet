...
export function RuneWorkingPill({ step, startedAt, onStop }: Props): React.JSX.Element {
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-fleet-border-strong bg-fleet-surface-2 px-3 py-1 text-xs text-neutral-200 shadow-xl ring-1 ring-white/15">
